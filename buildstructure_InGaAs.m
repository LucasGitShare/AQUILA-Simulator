...
if carr+qcarr>0 %we have gamma electrons
   aquila_material.eg=ingaasmaterial(aquila_material.xcontentx,'E_g'); %their energy level
   aquila_material.megd=ingaasmaterial(aquila_material.xcontentx,'M_eG'); %DOS mass
   aquila_material.eg6g8=ingaasmaterial(aquila_material.xcontentx,'E_G6G8'); %G6-G8 energy distance
   if qcarr>0 %mass for solving Schroedingers equation is needed
      aquila_material.meg=ingaasmaterial(aquila_material.xcontent,'M_eG');
   end   
end
...
if carr+qcarr>0
   aquila_material.ex=ingaasmaterial(aquila_material.xcontentx,'E_x');
   aquila_material.mexd=ingaasmaterial(aquila_material.xcontentx,'M_eXd');
   if qcarr>0
      aquila_material.mex=ingaasmaterial(aquila_material.xcontent,'M_eG');
   end   
end
%L electrons
...
if carr+qcarr>0
   aquila_material.el=ingaasmaterial(aquila_material.xcontentx,'E_l');
   aquila_material.meld=ingaasmaterial(aquila_material.xcontentx,'M_eLd');
   if qcarr>0
      aquila_material.mel=ingaasmaterial(aquila_material.xcontent,'M_eL');
   end   
end
%heavy holes
...
if carr+qcarr>0
   aquila_material.ev=ingaasmaterial(aquila_material.xcontentx,'E_v');
   aquila_material.mhhd=ingaasmaterial(aquila_material.xcontentx,'M_hhd');
   if qcarr>0
      aquila_material.mhh001=ingaasmaterial(aquila_material.xcontent,'M_hh001');
      aquila_material.mhh110=ingaasmaterial(aquila_material.xcontent,'M_hh110');
   end   
end
%light holes
...
if carr+qcarr>0
   aquila_material.ev=ingaasmaterial(aquila_material.xcontentx,'E_v');
   aquila_material.mlhd=ingaasmaterial(aquila_material.xcontentx,'M_lhd');
   if qcarr>0
      aquila_material.mlh001=ingaasmaterial(aquila_material.xcontent,'M_lh001');
      aquila_material.mlh110=ingaasmaterial(aquila_material.xcontent,'M_lh110');
   end   
end
%split-off holes
...
if carr+qcarr>0
   aquila_material.eso=ingaasmaterial(aquila_material.xcontentx,'E_so');
   aquila_material.msod=ingaasmaterial(aquila_material.xcontentx,'M_so');
   if qcarr>0
      aquila_material.mso=ingaasmaterial(aquila_material.xcontent,'M_so');
   end   
end
%donator level
aquila_material.dop=ingaasmaterial(aquila_material.xcontentx,'E_d');
%epsilon
aquila_material.epsilon=ingaasmaterial(aquila_material.xcontent,'eps');
if ~isempty(aquila_structure.pbox)
   aquila_material.ev=ingaasmaterial(aquila_material.xcontentx,'E_v');
   aquila_material.ec=ingaasmaterial(aquila_material.xcontentx,'E_c');
end
